...
public class ReactorHttpDifferenceProxy {
    ...
    private final Endpoint<AnalysisRequest, CompletableFuture<Optional<DifferenceResult>>> analyzer;
    ...
    public ReactorHttpDifferenceProxy(
        ...
        this.joinedDifferences = new JoinedDifferences(raw, noise);
        ...
        analyzer = Async.common(Endpoint.from(
            "analyzerWithRepo",
                ...
                (BinaryOperator<AnalysisRequest,
                        ...
                        Optional<DifferenceResult>>) (analyzerLambda, repoSave) -> analyzerLambda.andThen(ro -> ro.map(r -> repoSave.apply(r)))
        ));
        multicastProxy =
            Endpoint.from(
                "buffer",
